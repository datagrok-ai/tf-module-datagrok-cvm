...
| <a name="input_bucket_logging"></a> [bucket\_logging](#input\_bucket\_logging) | n/a | <pre>object({<br>    log_bucket        = optional(string)<br>    create_log_bucket = bool<br>    enabled           = bool<br>  })</pre> | <pre>{<br>  "create_log_bucket": true,<br>  "enabled": true<br>}</pre> | no |
...
| <a name="input_create_vpc"></a> [create\_vpc](#input\_create\_vpc) | n/a | `string` | `true` | no |
...
| <a name="input_docker_hub_credentials"></a> [docker\_hub\_credentials](#input\_docker\_hub\_credentials) | n/a | <pre>object({<br>    create_secret = bool<br>    password      = optional(string)<br>    user          = optional(string)<br>    secret_arn    = optional(string)<br>  })</pre> | <pre>{<br>  "create_secret": true<br>}</pre> | no |
...
| <a name="input_route53_external_zone"></a> [route53\_external\_zone](#input\_route53\_external\_zone) | Route53 external hosted zone ID. If it is not set create\_route53\_external\_zone is required to be true | `string` | `null` | no |
...
| <a name="input_service_discovery_namespace"></a> [service\_discovery\_namespace](#input\_service\_discovery\_namespace) | n/a | <pre>object({<br>    create = bool<br>    id     = optional(string)<br>  })</pre> | <pre>{<br>  "create": true<br>}</pre> | no |
