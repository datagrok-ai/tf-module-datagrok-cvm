...
| <a name="input_jkgIsolatesCount"></a> [jkgIsolatesCount](#input\_jkgIsolatesCount) | n/a | `number` | `1` | no |
...
| <a name="input_lb_access_cidr_blocks"></a> [lb\_access\_cidr\_blocks](#input\_lb\_access\_cidr\_blocks) | The CIDR to from which the access Datagrok load balancer is allowed. | `list(string)` | <pre>[<br/>  "0.0.0.0/0"<br/>]</pre> | no |
...
| <a name="input_pipe_host"></a> [pipe\_host](#input\_pipe\_host) | n/a | `string` | `"grok_pipe"` | no |
| <a name="input_pipe_key"></a> [pipe\_key](#input\_pipe\_key) | n/a | `string` | `"test-key"` | no |
...
| <a name="input_rabbitmq_name"></a> [rabbitmq\_name](#input\_rabbitmq\_name) | Server for AmazonMQ | `string` | `"rabbitmq"` | no |
